...
const _c0 = function (a2) { return { "row": true, "upload": true, "dragzone": a2 }; };
class AppComponent {
    constructor(http) {
        this.http = http;
    ...
    uploadFiles(event) {
        ...
        if (event.dataTransfer.items) {
            for (var i = 0; i < event.dataTransfer.items.length; i++) {
                ...
                debugger;
                this.http.post('/api/Videos', formData, { reportProgress: true, observe: 'events' }).subscribe(event => {
...
AppComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: AppComponent, selectors: [["app-root"]], decls: 42, vars: 3, consts: [[1, "rgba-gradient"], [1, "jumbotron", "text-center"], ["id", "FileUpload"], [1, "wrapper"], ["draggable", "true", 3, "ngClass", "drop", "dragover"], ["xmlns", "http://www.w3.org/2000/svg", "width", "50", "height", "43", "viewBox", "0 0 50 43", 1, "box__icon"], ["d", "M48.4 26.5c-.9 0-1.7.7-1.7 1.7v11.6h-43.3v-11.6c0-.9-.7-1.7-1.7-1.7s-1.7.7-1.7 1.7v13.2c0 .9.7 1.7 1.7 1.7h46.7c.9 0 1.7-.7 1.7-1.7v-13.2c0-1-.7-1.7-1.7-1.7zm-24.5 6.1c.3.3.8.5 1.2.5.4 0 .9-.2 1.2-.5l10-11.6c.7-.7.7-1.7 0-2.4s-1.7-.7-2.4 0l-7.1 8.3v-25.3c0-.9-.7-1.7-1.7-1.7s-1.7.7-1.7 1.7v25.3l-7.1-8.3c-.7-.7-1.7-.7-2.4 0s-.7 1.7 0 2.4l10 11.6z"], [1, "margin-left-1"], ["type", "file", "name", "file", "id", "file", 1, "inputfile", 3, "change"], ["for", "file"], [1, "container"], [1, "row"], [1, "col-sm-8", "well"], [1, "margin-h3"], [1, "col-lg-10"], ["id", "video1", "src", "./src/app/Videos/DummyVideo.mp4", "width", "99%", "controls", "", "autoplay", "", "muted", "", "type", "video/mp4"], [1, "col-sm-4"], [1, "uploaded", "uploaded--one"], [1, "far", "fa-file-video"], [1, "file"], [1, "file__name"], [1, "fas", "fa-times"], [1, "progress"], [1, "progress-bar", "bg-success", "progress-bar-striped", "progress-bar-animated", 2, "width", "100%"], [1, "page-footer", "font-small", "blue", "pt-4"], [1, "footer-copyright", "text-center", "py-3"], ["href", "https://mdbootstrap.com/"]], template: function AppComponent_Template(rf, ctx) { if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("drop", function AppComponent_Template_div_drop_6_listener($event) { return ctx.uploadFiles($event); })("dragover", function AppComponent_Template_div_dragover_6_listener($event) { return ctx.dragover($event); });
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("change", function AppComponent_Template_input_change_10_listener($event) { return ctx.uploadFiles($event); });
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
...
module.exports = __webpack_require__(/*! C:\Ashutosh\MyProjects\Upload Video Project\upload-video-AWS-app\src\main.ts */"./src/main.ts");
